...
import {
  LayoutDashboard, FolderOpen, ClipboardCheck, Users,
...
export function ClientSidebar() {
  ...
  const bottomNavItems = clientNav.slice(0, 4);
    ...
    <>
        ...
        <div className="flex items-center justify-between px-4 h-13">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] text-gray-400 ml-1.5">{t("role.client")}</span>
            </div>
          </div>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="fixed right-0 top-0 bottom-0 w-[300px] bg-white flex flex-col shadow-2xl rounded-l-3xl">
            ...
            <div className="px-5 pb-4">
              <div className="flex items-center gap-3 bg-blue-50 rounded-2xl p-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-blue-600 font-medium">{t("role.client")}</p>
                </div>
              </div>
            </div>
            ...
            {/* Switch to Inspector mode */}
            <div className="px-5 pb-4">
              <p className="text-xs uppercase text-gray-400 font-bold mb-2.5 tracking-wider">{t("switch_role")}</p>
              <button onClick={() => { setRole("inspector"); router.push("/inspector"); setMobileOpen(false); }}
            ...
            <div className="px-5 py-5 border-t border-gray-100">
              <button onClick={() => { reset(); router.push("/client"); setMobileOpen(false); }}
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-white border-r border-gray-200">
        <div className="flex items-center gap-2.5 px-5 py-5 border-b border-gray-200">
          <LogoFull size="sm" />
          <span className="text-[10px] text-gray-400 ml-auto">{t("role.client")}</span>
        </div>
        <nav className="flex-1 px-3 py-3 overflow-y-auto" aria-label="Desktop navigation">
          ...
          <div className="mt-4 pt-4 border-t border-gray-100">
            ...
            <button onClick={() => { setRole("inspector"); router.push("/inspector"); }}
        ...
        <div className="px-4 py-4 border-t border-gray-200">
          <div className="flex items-center gap-3 px-2 mb-3">
            <div className="w-8 h-8 bg-blue-600/10 rounded-full flex items-center justify-center text-xs font-bold text-blue-600 shrink-0">
              {user.full_name.charAt(0)}
            </div>
            <div className="flex-1 min-w-0">
