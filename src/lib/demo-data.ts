...
export const demoInspector: User = {
  id: "inspector-1",
...
// Matches real Georgian forms: bilingual Georgian+English labels, questionnaire + components sections
const demoTemplates: TemplateWithItems[] = [
  {
    id: "tmpl-1", name: "ფასადის ხარაჩოს შემოწმების აქტი", category: "scaffold_fixed", company_id: null, created_at: "2024-01-01T00:00:00Z",
    items: [
      // Questionnaire section (yes/no-style questions from real form)
      { id: "ti-1-q1", template_id: "tmpl-1", text: "გააჩნია თუ არა ხარაჩოს პასპორტი ქართულად ნათარგმნი?", text_en: "Does the scaffolding have a passport translated into Georgian?", section: "questionnaire", order_index: 1, is_critical: true },
      { id: "ti-1-q2", template_id: "tmpl-1", text: "გააჩნია თუ არა ხარაჩოს ვადიანი, ქართულად ნათარგმნი სერთიფიკატი?", text_en: "Does the scaffolding have a valid certificate translated into Georgian?", section: "questionnaire", order_index: 2, is_critical: true },
      { id: "ti-1-q3", template_id: "tmpl-1", text: "ხარაჩო აწყობილია სწორ და მყარ ზედაპირზე?", text_en: "Is the scaffolding installed on a flat and stable surface?", section: "questionnaire", order_index: 3, is_critical: true },
      { id: "ti-1-q4", template_id: "tmpl-1", text: "სამუშაო პლატფორმასა და შენობის ნაგებობას შორის დაშორება აღემატება 25 სანტიმეტრს?", text_en: "Is the distance between the working platform and the building structure 25 cm or greater?", section: "questionnaire", order_index: 4, is_critical: false },
      { id: "ti-1-q5", template_id: "tmpl-1", text: "ხარაჩოს პლატფორმაზე დამატებით განთავსებულია კუსტარული კიბე ან სადგამი პლატფორმა?", text_en: "Is there any additional makeshift ladder or working platform installed on the scaffolding platform?", section: "questionnaire", order_index: 5, is_critical: false },
      // Components section (damage check on each physical part)
      { id: "ti-1-1", template_id: "tmpl-1", text: "რეგულირებადი დომკრატი", text_en: "Adjustable Base Jack", section: "components", order_index: 6, is_critical: true },
      { id: "ti-1-2", template_id: "tmpl-1", text: "სადგამი, საბაზისო ფირფიტა", text_en: "Base Plate", section: "components", order_index: 7, is_critical: true },
      { id: "ti-1-3", template_id: "tmpl-1", text: "ვერტიკალური საყრდენი ჩარჩო", text_en: "Vertical Frame", section: "components", order_index: 8, is_critical: true },
      { id: "ti-1-4", template_id: "tmpl-1", text: "პლატფორმა - ლუქიანი პლატფორმა", text_en: "Trapdoor platform", section: "components", order_index: 9, is_critical: true },
      { id: "ti-1-5", template_id: "tmpl-1", text: "ჰორიზონტალური ქვედა დამცავი დაფა", text_en: "Toe Board", section: "components", order_index: 10, is_critical: true },
      { id: "ti-1-6", template_id: "tmpl-1", text: "ზედა და შუა დამცავი მოაჯირი", text_en: "Guardrail / Mid Rail", section: "components", order_index: 11, is_critical: true },
      { id: "ti-1-7", template_id: "tmpl-1", text: "გვერდის დამცავი მოაჯირი", text_en: "Side guardrail", section: "components", order_index: 12, is_critical: true },
      { id: "ti-1-8", template_id: "tmpl-1", text: "ასასვლელი კიბე", text_en: "Access Ladder", section: "components", order_index: 13, is_critical: true },
      { id: "ti-1-9", template_id: "tmpl-1", text: "ანკერული გამაგრება", text_en: "Anchor Bracket", section: "components", order_index: 14, is_critical: true },
    ],
  },
  {
  ...
  {
    id: "tmpl-4", name: "დამცავი ქამრების შემოწმების აქტი", category: "harness_ppe", company_id: null, created_at: "2024-01-01T00:00:00Z",
    items: [
      // All components from the real fall-protection harness form
      { id: "ti-4-1", template_id: "tmpl-4", text: "მხრის ღვედები", text_en: "Shoulder Straps", section: "components", order_index: 1, is_critical: true },
      { id: "ti-4-2", template_id: "tmpl-4", text: "მკერდის ღვედი სწრაფი დამაგრების ჩამკეტი", text_en: "Chest Strap / Quick Connect Buckle", section: "components", order_index: 2, is_critical: true },
      { id: "ti-4-3", template_id: "tmpl-4", text: "გვერდითი D-ბეჭდები", text_en: "Side D-RING", section: "components", order_index: 3, is_critical: true },
      { id: "ti-4-4", template_id: "tmpl-4", text: "ფეხის ღვედი რეგულირებადი ჩამკეტით", text_en: "Leg Straps with Leg Buckles / Adjusters", section: "components", order_index: 4, is_critical: true },
      { id: "ti-4-5", template_id: "tmpl-4", text: "წელის ღვედი, რეგულირებადი საკეტით", text_en: "Waist Belt with Buckle", section: "components", order_index: 5, is_critical: false },
      { id: "ti-4-6", template_id: "tmpl-4", text: "ჩამკეტიანი კავი / სამაგრი", text_en: "Locking hook", section: "components", order_index: 6, is_critical: true },
      { id: "ti-4-7", template_id: "tmpl-4", text: "თოკის დამცავი", text_en: "Rope Protector", section: "components", order_index: 7, is_critical: false },
      { id: "ti-4-8", template_id: "tmpl-4", text: "დამცავი თოკი", text_en: "Safety Rope", section: "components", order_index: 8, is_critical: true },
      { id: "ti-4-9", template_id: "tmpl-4", text: "ჩამკეტი კარაბინი", text_en: "Locking carabiner", section: "components", order_index: 9, is_critical: true },
      { id: "ti-4-10", template_id: "tmpl-4", text: "ენერგიის შთანთქმის მოწყობილობა", text_en: "Energy Absorber", section: "components", order_index: 10, is_critical: true },
    ],
  },
  {
...
const demoInspections: InspectionWithItems[] = [
  {
    ...
    items: [
      // Questionnaire (5)
      { id: "ii-q1", inspection_id: "insp-1", template_item_id: "ti-1-q1", status: "safe", comment: null, is_critical: true, template_item: demoTemplates[0].items[0], photos: [] },
      { id: "ii-q2", inspection_id: "insp-1", template_item_id: "ti-1-q2", status: "safe", comment: null, is_critical: true, template_item: demoTemplates[0].items[1], photos: [] },
      { id: "ii-q3", inspection_id: "insp-1", template_item_id: "ti-1-q3", status: "safe", comment: null, is_critical: true, template_item: demoTemplates[0].items[2], photos: [] },
      { id: "ii-q4", inspection_id: "insp-1", template_item_id: "ti-1-q4", status: "violation", comment: "მანძილი ცოტა ნაკლებია ნორმაზე", is_critical: false, template_item: demoTemplates[0].items[3], photos: [] },
      { id: "ii-q5", inspection_id: "insp-1", template_item_id: "ti-1-q5", status: "not_applicable", comment: null, is_critical: false, template_item: demoTemplates[0].items[4], photos: [] },
      // Components (9)
      { id: "ii-1", inspection_id: "insp-1", template_item_id: "ti-1-1", status: "safe", comment: null, is_critical: true, template_item: demoTemplates[0].items[5], photos: [] },
      { id: "ii-2", inspection_id: "insp-1", template_item_id: "ti-1-2", status: "safe", comment: null, is_critical: true, template_item: demoTemplates[0].items[6], photos: [] },
      { id: "ii-3", inspection_id: "insp-1", template_item_id: "ti-1-3", status: "safe", comment: null, is_critical: true, template_item: demoTemplates[0].items[7], photos: [] },
      { id: "ii-4", inspection_id: "insp-1", template_item_id: "ti-1-4", status: "violation", comment: "ლუქი არასწორად ფიქსირდება", is_critical: true, template_item: demoTemplates[0].items[8], photos: [] },
      { id: "ii-5", inspection_id: "insp-1", template_item_id: "ti-1-5", status: "violation", comment: "2 მოაჯირი აკლია მე-3 სართულზე", is_critical: true, template_item: demoTemplates[0].items[9], photos: [] },
      { id: "ii-6", inspection_id: "insp-1", template_item_id: "ti-1-6", status: "safe", comment: null, is_critical: true, template_item: demoTemplates[0].items[10], photos: [] },
      { id: "ii-7", inspection_id: "insp-1", template_item_id: "ti-1-7", status: "safe", comment: null, is_critical: true, template_item: demoTemplates[0].items[11], photos: [] },
      { id: "ii-8", inspection_id: "insp-1", template_item_id: "ti-1-8", status: "violation", comment: "მცირე კოროზია ქვედა ნაწილში", is_critical: true, template_item: demoTemplates[0].items[12], photos: [] },
      { id: "ii-9", inspection_id: "insp-1", template_item_id: "ti-1-9", status: "safe", comment: null, is_critical: true, template_item: demoTemplates[0].items[13], photos: [] },
    ],
  },
  {
    id: "insp-2",
    ...
    items: [
      ...
      { id: "ii-2-4", inspection_id: "insp-2", template_item_id: "ti-4-4", status: "violation", comment: "ზომა ცოტა დიდია", is_critical: false, template_item: demoTemplates[3].items[3], photos: [] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ii-3-2", inspection_id: "insp-3", template_item_id: "ti-6-2", status: "violation", comment: "რამდენიმე ჩაფხუტი დაზიანებულია", is_critical: false, template_item: demoTemplates[5].items[1], photos: [] },
      ...
      { id: "ii-3-5", inspection_id: "insp-3", template_item_id: "ti-6-5", status: "violation", comment: null, is_critical: false, template_item: demoTemplates[5].items[4], photos: [] },
    ],
  },
  {
    id: "insp-4",
    ...
    items: [
      ...
      { id: "ii-4-5", inspection_id: "insp-4", template_item_id: "ti-5-5", status: "violation", comment: "ვადა იწურება მომავალ თვეს", is_critical: false, template_item: demoTemplates[4].items[4], photos: [] },
    ],
  },
  {
    id: "insp-5",
    ...
    items: [
      ...
      { id: "ii-5-3", inspection_id: "insp-5", template_item_id: "ti-2-3", status: "violation", comment: "მცირე რხევა ზედა ნაწილში", is_critical: true, template_item: demoTemplates[1].items[2], photos: [] },
